var ConsoleReporter, Docker, DockerUtils, PromiseUtils, RSVP, ServiceHelpers, _, chalk, findContainerName, help, lookupServiceConfig, maybeRemoveContainer, minimist, removeImage,
  slice = [].slice;
